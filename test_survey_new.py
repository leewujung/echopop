...
init_config_path = f"/Users/wujung/code_git/echopop/config_files/initialization_config_{SURVEY_YEAR}.yml"

# Filepath/dataset configuration
survey_year_config_path = f"/Users/wujung/code_git/echopop/config_files/survey_year_{SURVEY_YEAR}_config.yml"

# Load json settings
# ---- File open
# with open(Path(os.getcwd() + "\\echopop\\compatibility_parameters_test.json").as_posix()) as f:
with open(Path("/Users/wujung/code_git/echopop/echopop/compatibility_parameters_test.json").as_posix()) as f:
